<template>
            ...
            <table class="w-full text-sm">
                ...
                <tbody>
                    ...
                    <tr v-if="!milestones.data?.length">
                        <td colspan="7" class="text-center py-8 text-gray-400 text-sm">No milestones yet.</td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <Modal :show="showModal" :title="editingId ? 'Edit Milestone' : 'New Milestone'" max-width="lg" @close="closeModal">
...
function editEntry(m) {
    ...
    form.milestone_code = m.milestone_code;
    form.pp_project_id = m.pp_project_id;
    form.milestone = m.milestone;
    form.actual_date = m.actual_date || '';
